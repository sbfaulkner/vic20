...
module Vic20
  class Processor
    ...
    INSTRUCTIONS = {
      0x00 => { method: :brk, addressing_mode: :implied,     cycles: 2 }, # TODO: implement BRK (addressing_mode)
      ...
      0x09 => { method: :ora, addressing_mode: :immediate,   cycles: 2 }, # TODO: implement ORA (immediate)
      0x0A => { method: :asl, addressing_mode: :accumulator, cycles: 2 }, # TODO: implement ASL (accumulator)
      ...
      0x10 => { method: :bpl, addressing_mode: :relative,    cycles: 2 }, # TODO: implement BPL (relative)
      ...
      0x16 => { method: :asl, addressing_mode: :zero_page_x, cycles: 6 }, # TODO: implement ASL (zero_page_x)
      0x18 => { method: :clc, addressing_mode: :implied,     cycles: 2 }, # TODO: implement CLC (implied)
      ...
      0x29 => { method: :and, addressing_mode: :immediate,   cycles: 2 }, # TODO: implement AND (immediate)
      ...
      0x30 => { method: :bmi, addressing_mode: :relative,    cycles: 2 }, # TODO: implement BMI (relative)
      ...
      0x55 => { method: :eor, addressing_mode: :zero_page_x, cycles: 4 }, # TODO: implement EOR (zero_page_x)
      ...
      0x70 => { method: :bvs, addressing_mode: :relative,    cycles: 2 }, # TODO: implement BVS (relative)
      ...
      0x81 => { method: :sta, addressing_mode: :indirect_x,  cycles: 6 }, # TODO: implement STA (indirect_x)
      ...
      0x8A => { method: :txa, addressing_mode: :implied,     cycles: 2 }, # TODO: implement TXA (implied)
      ...
      0x90 => { method: :bcc, addressing_mode: :relative,    cycles: 2 }, # TODO: implement BCC (relative)
      0x91 => { method: :sta, addressing_mode: :indirect_y,  cycles: 6 }, # TODO: implement STA (indirect_y)
      ...
      0x96 => { method: :stx, addressing_mode: :zero_page_y, cycles: 4 }, # TODO: implement STX (zero_page_y)
      0x98 => { method: :tya, addressing_mode: :implied,     cycles: 2 }, # TODO: implement TYA (implied)
      0x99 => { method: :sta, addressing_mode: :absolute_y,  cycles: 5 }, # TODO: implement STA (absolute_y)
      ...
      0xA4 => { method: :ldy, addressing_mode: :zero_page,   cycles: 3 }, # TODO: implement LDY (zero_page)
      0xA5 => { method: :lda, addressing_mode: :zero_page,   cycles: 3 }, # TODO: implement LDA (zero_page)
      ...
      0xAD => { method: :lda, addressing_mode: :absolute,    cycles: 4 }, # TODO: implement LDA (absolute)
      0xAE => { method: :ldx, addressing_mode: :absolute,    cycles: 4 }, # TODO: implement LDX (absolute)
      0xB0 => { method: :bcs, addressing_mode: :relative,    cycles: 2 }, # TODO: implement BCS (relative)
      0xB1 => { method: :lda, addressing_mode: :indirect_y,  cycles: 5 },
      0xB4 => { method: :ldy, addressing_mode: :zero_page_x, cycles: 4 }, # TODO: implement LDY (zero_page_x)
      ...
      0xC0 => { method: :cpy, addressing_mode: :immediate,   cycles: 2 }, # TODO: implement CPY (immediate)
      0xC1 => { method: :cmp, addressing_mode: :indirect_x,  cycles: 6 }, # TODO: implement CMP (indirect_x)
      0xC4 => { method: :cpy, addressing_mode: :zero_page,   cycles: 3 }, # TODO: implement CPY (zero_page)
      0xC5 => { method: :cmp, addressing_mode: :zero_page,   cycles: 3 }, # TODO: implement CMP (zero_page)
      0xC6 => { method: :dec, addressing_mode: :zero_page,   cycles: 5 }, # TODO: implement DEC (zero_page)
      0xC8 => { method: :iny, addressing_mode: :implied,     cycles: 2 }, # TODO: implement INY (implied)
      0xC9 => { method: :cmp, addressing_mode: :immediate,   cycles: 2 }, # TODO: implement CMP (immediate)
      0xCA => { method: :dex, addressing_mode: :implied,     cycles: 2 }, # TODO: implement DEX (implied)
      ...
      0xF8 => { method: :sed, addressing_mode: :implied,     cycles: 2 }, # TODO: implement SED (implied)
