...
class Vic20::Processor::Instructions::BCCTest < Vic20::Processor::Test
  def test_branches_when_carry_flag_is_clear
    pc = 0xfdde
    offset = 3
  ...
  def test_does_not_branch_when_carry_flag_is_set
    pc = 0xfdde
    offset = 3
