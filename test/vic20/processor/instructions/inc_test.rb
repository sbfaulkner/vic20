...
class Vic20::Processor::Instructions::INCTest < Vic20::Processor::Test
  ...
  def test_absolute_addressing_mode_zero_result
    address = 0x1c05
    value = 0xff
    ...
    assert_equal(0, @memory.get_byte(address))
    refute_sign_flag
    assert_zero_flag
  end
  ...
  def test_absolute_x_addressing_mode_zero_result
    address = 0x1cd5
    offset = 0xbb
    value = 0xff
    ...
    assert_equal(0, @memory.get_byte(address + offset))
    refute_sign_flag
    assert_zero_flag
  end
  ...
  def test_zero_page_addressing_mode_zero_result
    address = 0xc1
    value = 0xff
  ...
  def test_zero_page_x_addressing_mode_zero_result
    address = 0xc1
    offset = 0x18
    value = 0xff
