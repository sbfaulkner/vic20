...
class Vic20::Processor::Instructions::BPLTest < Vic20::Processor::Test
  def test_branches_when_sign_flag_is_clear
    pc = 0xfd49
    offset = 3
  ...
  def test_does_not_branch_when_sign_flag_is_set
    pc = 0xfd49
    offset = 3
